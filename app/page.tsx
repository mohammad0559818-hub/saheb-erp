    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,#dbeafe,transparent_35%),#f8fafc]">
      <section className="mx-auto max-w-7xl px-6 py-10">
        <nav className="flex items-center justify-between rounded-full border border-white/70 bg-white/80 px-6 py-4 shadow-sm backdrop-blur">
          ...
          <div className="flex gap-2"><a className="rounded-full border px-5 py-2.5 font-semibold" href="/setup">الإعداد الأول</a><a className="rounded-full bg-blue-700 px-5 py-2.5 font-semibold text-white" href="/auth/login">دخول النظام</a></div>
        </nav>
        <div className="grid gap-8 py-16 lg:grid-cols-[1.1fr_.9fr] lg:items-center">
          <div>
            ...
            <div className="mt-8 flex gap-3"><a className="rounded-2xl bg-blue-700 px-6 py-3 font-bold text-white" href="/setup">ابدأ الإعداد الإنتاجي</a><a className="rounded-2xl border border-slate-300 bg-white px-6 py-3 font-bold" href="/api/erp">فهرس APIs</a></div>
          </div>
